 ...
 */
internal class RxJavaSupportProvider : LibrarySupportProvider {
  private companion object {
    private const val CLASS_NAME = "io.reactivex.rxjava3.core.ObservableSource"
  }

  private val librarySupport = RxJavaSupport()
